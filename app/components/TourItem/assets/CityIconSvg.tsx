...
export default function CityIconSvg() {
  return (
    <svg
      width='15px'
      height='15px'
      ...
      <path d='M10 15H14' stroke='#1C274C' strokeWidth='1.5' strokeLinecap='round' />
      <path d='M10 18H14' stroke='#1C274C' strokeWidth='1.5' strokeLinecap='round' />
    </svg>
  );
}
